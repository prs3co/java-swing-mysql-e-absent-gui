...
private void autoid(){
    try {
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/eabsent","root","");
        Statement stm = con.createStatement();
        ResultSet rs = stm.executeQuery("SELECT * FROM absen ORDER BY id_absen DESC");
        if (rs.next()){
    ...
    private void initComponents() {
        ...
        prtmn1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2021-10-01 - 2021-10-31", "2021-11-01 - 2021-11-30", "2021-12-01 - 2021-12-31" }));
